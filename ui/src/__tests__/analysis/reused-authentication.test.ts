...
test("runner works", async () => {
  const query = () => Promise.resolve([
    { auth_header: "auth-header-1", absolute_uri: "/url-1", src_ip: "192.0.2.1", timestamp: 1672578721000 },
    { auth_header: "auth-header-1", absolute_uri: "/url-1", src_ip: "192.0.2.2", timestamp: 1672578723000 },
    { auth_header: "auth-header-1", absolute_uri: "/url-2", src_ip: "192.0.2.1", timestamp: 1672578725000 },
  ]);
