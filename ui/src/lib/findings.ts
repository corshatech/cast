...
export type IFinding<Type extends string, DataType extends Record<string, any>> = {
...
export type ReusedAuthentication = IFinding<"reused-auth", {
...
export type ExpiredJWT = IFinding<"expired-jwt", {
  /** The JWT of concern */
  jwt: string;
...
export type UseOfBasicAuth = IFinding<"use-of-basic-auth", {
  inRequest: RequestContext;
}>;
